...
export const gallery_pages: Array<GalleryTextsDataValue> = [
  ...
  },
  {
    ...
    type: "akce",
    display_date: "18. 4. 2025",
    day: 18,
    month: 4,
    year: 2025,
    title: "Bojová linie Kadlečák&nbsp;4",
    main_text: `
...
<p>
Po této misi nás opustil zraněný Láďa, zážitky nabitý Šnek a Lulu, který řídil auto. Do této chvíle Láďa neplnil bojové úkoly s jednotkou. Staral se o provoz základny, vařil válečníkům kafe v džezvě a prováděl odposlech radioprovozu. </p>
...
<b>Sobota</b><br/>
<p>
  První úkol byl obsadit a udržet do 10 hod. kopec Doubek, který byl již obsazen ISAF. Vojáci dokázali zlikvidovat vše, co se pod kopcem pohnulo, nicméně se některým povstalcům podařilo připlížit se až těsně pod vrchol, na dosah k vojákům, vzhledem k vzájemné blízkosti (pod 10 m) došlo na pistolovou přestřelku. Tímto chválíme posádku ISAF, co byla v okopu, že k obraně použili pistole. Kopec se nám nepodražilo v časovém termínu získat.
</p> <br/>
<p>
...
<b>Neděle</b><br/>
<p>
  Cílem bylo obsadit vrchol kopce, kde byl již zakopaný protivník, který svou pozici houževnatě bránil. Postupně se dařilo ISAF likvidovat, bohužel i povstalecké řady prořídli, a bohužel i díky friendly fire (což fakt nechápeme, předci vím, kam, střílím!), takže jsme se jako mrtvoly přesouvali do vesnice a hra pro nás skončila.
</p> <br/>
<p>
